			...
			elseif not is_hash1 and not is_hash2 then
			    ...
			    if msg.to.type == "channel" then
				    ...
				    elseif redis:get("sp:lang") == "fa" then
					    help = http.request("http://csgroups.ir/boting/1473700489.txt")
						return help
					elseif redis:get("sp:lang") == "en" then
					    help = http.request("http://csgroups.ir/boting/1473726399.txt")
						return help
				    elseif redis:get("sp:lang") == "فا" then
					    help = http.request("http://csgroups.ir/boting/1473703817.txt")
						return help
					end
				elseif msg.to.type == "chat" then
				    ...
				    elseif redis:get("gp:lang") == "fa" then
					    help = http.request("http://csgroups.ir/boting/1473685968.txt")
						return help
					elseif redis:get("gp:lang") == "en" then
					    help = http.request("http://csgroups.ir/boting/1473743959.txt")
						return help
				    elseif redis:get("gp:lang") == "فا" then
					    help = http.request("http://csgroups.ir/boting/1473704736.txt")
						return help
					end
				end
			end
