...
function run(msg, matches)
 ...
 if matches[1] == "setlang" and matches[2] == "fa" then
    ...
    file = http.request("http://csgroups.ir/boting/supergroup-fa.txt")
	tools = http.request("http://csgroups.ir/boting/tools-fa4.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
...
elseif matches[1] == "setlang" and matches[2] == "en" then
    ...
    file = http.request("http://csgroups.ir/boting/supergroup-en.txt")
	tools = http.request("http://csgroups.ir/boting/tools-en4.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
...
elseif matches[1] == "setlang" and matches[2] == "فا" then
    ...
    file = http.request("http://csgroups.ir/boting/supergroup-farsi.txt")
	tools = http.request("http://csgroups.ir/boting/tools-farsi4.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
...
if msg.to.type == 'chat' then
 if matches[1] == "setlang" and matches[2] == "fa" then
    ...
    file = http.request("http://csgroups.ir/boting/1471088420.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
 ...
 elseif matches[1] == "setlang" and matches[2] == "en" then
    ...
    file = http.request("http://csgroups.ir/boting/1475331538.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
 ...
 elseif matches[1] == "setlang" and matches[2] == "فا" then
    ...
    file = http.request("http://csgroups.ir/boting/1471124062.txt")
    local b = 1
    while b ~= 0 do
    file = file:trim()
    file,b = file:gsub('^!+','')
